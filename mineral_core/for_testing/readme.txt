mineral_core MATLAB Python Package
...
2. Installing the mineral_core Package

A. Change to the directory that contains the file setup.py and the subdirectory 
mineral_core. If you do not have write permissions, copy all its contents to a temporary 
...
3. Using the mineral_core Package

The mineral_core package is on your Python path. To import it into a Python script or 
session, execute:
